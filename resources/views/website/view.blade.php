...
<img id="myImg" src="{{asset('website/assets/images/img-01.jpg')}}" alt="Snow" style="width:100%;max-width:300px">
                ...
                <div class="col-xs-6 col-md-3">
                    ...
                    <div style="margin-left: 10px; margin-right: 10px">
                        ...
                        <div style="text-align: center">
                            ...
                            <p class="txt m">Age {{$profile_extra->age}} {{($profile_extra->age +(int)$profile->started_year)}}</p>
                        </div>
                    </div>
                </div>
                @endforeach
