...
<div class="row">
 ...
 <div class="row">
  ...
  <input class="form-control  rounded-pill " type="search" placeholder="Seach for the name"  id="example-search-input2" style="width: 100%; border-radius: 20px; text-align: center;">
